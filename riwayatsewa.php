		...
		?>
			<tr>
				...
				<?php 
					...
					<a href="trx_bayar_hapus.php?id=<?php echo $result['id_trx'];?>" onclick="return confirm('Apakah anda yakin akan menghapus data <?php echo $result['id_trx'];?>?');" class="btn btn-primary btn-xs">Hapus</a></td>
					<?php }?>
				</td>
			</tr>
		<?php } ?>
