			...
			<table class="table table-borderless">
				<tbody>
					<tr>
						...
						<td class="text-center"><h3>Egg Photography</h3></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Phone : +62 858-5233-222 | E-mail : ask@tukangfoto.com</td>
					</tr>
					<tr>
						<td class="text-center">Bungursari, Purwakarta</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
