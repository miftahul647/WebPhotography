											...
											while($result=mysqli_fetch_array($query))
											{
												...
												<tr>
													...
													<td align='center'>
														...
														<a href="userdel.php?id=<?php echo $result['email'];?>" onclick="return confirm('Apakah anda yakin akan menghapus <?php echo $result['nama_user'];?>?');" class="btn btn-danger btn-xs">&nbsp;&nbsp;Hapus&nbsp;&nbsp;</a>
													</td>
												</tr>
												<?php } ?>
										</tbody>
